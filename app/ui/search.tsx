...
export default function Search({
	...
	const handleClick = async (player: PlayerSearch) => {
		...
		const playerData = await findPlayer(player.playerId)
	...
	return (
		<div className="relative flex flex-1 flex-shrink-0" ref={dropdownRef}>
			...
			<FontAwesomeIcon
				icon={faSearch}
				className="fa-fw absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900"
			/>
			{showDropdown && (
